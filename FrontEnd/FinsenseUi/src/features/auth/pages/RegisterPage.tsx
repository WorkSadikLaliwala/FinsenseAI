      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl shadow-slate-950/40 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-400">Get unlimited access to advanced forecasting & trackers</p>
          </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-2.5 bg-slate-950 border rounded-xl text-sm text-white placeholder-slate-500 outline-none transition-all duration-200
                    ${errors.fullName ? 'border-rose-500 focus:border-rose-500/30' : 'border-slate-800 focus:border-emerald-500/30 focus:ring-1 focus:ring-emerald-500/10'}
                  `}
                  {...register('fullName')}
                />
              </div>
              {errors.fullName && (
                <p className="mt-1.5 text-xs text-rose-400">{errors.fullName.message}</p>
              )}
            </div>
