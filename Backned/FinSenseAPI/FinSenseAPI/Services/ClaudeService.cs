...
public class ClaudeService : IClaudeService
{
        ...
        [EnumeratorCancellation] CancellationToken ct)
    {
        ...
        try
        {
            ...
            Console.WriteLine($"[ClaudeService] Response headers received at {DateTime.UtcNow:O}, status: {response.StatusCode}");
        }
        catch (Exception ex)
        {
            Console.WriteLine($"[ClaudeService] EXCEPTION before headers: {ex.GetType().Name}: {ex.Message}");
        ...
        while (true)
        {
            ...
            if (line == null) { Console.WriteLine("[ClaudeService] Stream ended (line null)"); break; }
